...
const styles = StyleSheet.create({
  page: { padding: 40, fontSize: 11, fontFamily: "Helvetica", alignItems: "center" },
  contentContainer: { width: "85%", alignItems: "flex-start" },
  headerRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 12 },
  header: { marginBottom: 0 , marginRight: 8},
  title: { fontSize: 18, marginBottom: 6 },
  meta: { fontSize: 10, color: "#666", marginBottom: 8 },
  riskBox: { width: 260, padding: 10, borderRadius: 2, borderWidth: 1, borderColor: "#e6e6e6", alignItems: "center" },
  gaugeWrap: { flexDirection: "row", alignItems: "center" },
  gaugeSvg: { marginRight: 8 },
  ...
  riskBarWrap: { width: "100%", height: 10, borderRadius: 6, marginTop: 6 },
  riskBar: { height: 10 },
  legendWrap: { marginTop: 8 },
  legendItem: { flexDirection: "row", alignItems: "center", marginBottom: 4 },
  legendSwatch: { width: 10, height: 10, marginRight: 8 },
        ...
        <View style={styles.contentContainer}>
          <View style={styles.headerRow}>
            ...
            <View style={styles.gaugeWrap}>
              <Svg width={150} height={75} style={styles.gaugeSvg} viewBox={`0 0 180 100`}>
                {
                  (() => {
                    const cx = 90;
                    const cy = 90; 
